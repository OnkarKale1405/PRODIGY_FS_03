                                    ...
                                    <div key={index} className="flex items-center mt-14 py-8 border-t border-gray-200">
                                        ...
                                        <div className="pl-3 w-3/4">
                                            <div className="flex items-center w-full pt-1">
                                                <p className="text-base font-black leading-none text-white">{item.name}</p>
                                            </div>
                                            <div className="flex items-center justify-between pt-5 pr-6">
                                                ...
                                                <p className="text-base font-black leading-none text-white">Rs {item.price}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="flex flex-col justify-between h-full py-20 px-14">
                                <div>
                                    ...
                                    <div className="flex items-center justify-between pt-16">
                                        <p className="text-xl leading-none text-white">Subtotal</p>
                                        <p className="text-xl leading-none text-white">{totalAmount}</p>
                                    </div>
                                    <div className="flex items-center justify-between pt-5">
                                        <p className="text-xl leading-none text-white">Shipping</p>
                                        <p className="text-xl leading-none text-white">50</p>
                                    </div>
                                    <div className="flex items-center justify-between pt-5">
                                        <p className="text-xl leading-none text-white">Tax</p>
                                        <p className="text-xl leading-none text-white">30</p>
                                    </div>
                                </div>
                                <div className="pt-20">
                                    <div className="flex items-center pb-6 justify-between">
                                        <p className="text-2xl leading-normal text-white">Total</p>
                                        <p className="text-2xl leading-normal text-white">{totalEnd}</p>
                                    </div>
